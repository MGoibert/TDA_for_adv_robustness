...
import pytest
import numpy as np
from tda.models.layers import LinearLayer, ConvLayer, AvgPool2dLayer, MaxPool2dLayer, AdaptativeAvgPool2dLayer
...
@pytest.mark.parametrize("layer,input_shape", [
    ...
    (ConvLayer(in_channels=2, out_channels=3, kernel_size=2, stride=1, input_shape=(7, 7)), (1, 2, 7, 7)),
    (AvgPool2dLayer(kernel_size=3), (1, 2, 7, 7)),
    (AdaptativeAvgPool2dLayer(output_size=(2, 2)), (1, 2, 7, 7)),
    #(MaxPool2dLayer(kernel_size=3), (1, 2, 7, 7))
])
